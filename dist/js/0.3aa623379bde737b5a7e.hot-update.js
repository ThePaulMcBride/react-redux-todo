...
/***/ function(module, exports, __webpack_require__) {
	...
	function mapStateToProps(state) {
	    console.log(state.get('filter').get('filter'));
	
	    return {
	        todos: state.get('todos').get('todos'),
	        filter: state.get('filter').get('filter'),
	        input: state.get('input').get('input')
	    };
	}
...
//# sourceMappingURL=0.3aa623379bde737b5a7e.hot-update.js.map